...
from dataset2 import AspectLinkDataset
from torch.utils.data import Dataset
from model4 import AspectLinkModel
from transformers import AutoTokenizer, get_linear_schedule_with_warmup
from trainers2 import Trainer
...
def main():
    ...
    model = AspectLinkModel(pretrained=pretrain, out_dim=args.entity_emb_dim, device=device)
    ...
    if args.freeze_bert:
        ...
        # for param in model.text_encoder.encoder.bert.parameters():
        #     param.requires_grad = False
        # for param in model.entity_encoder.encoder.desc_encoder.bert.parameters():
        #     param.requires_grad = False

        for param in model.context_entity_encoder.desc_encoder.bert.parameters():
            param.requires_grad = False
        for param in model.aspect_entity_encoder.desc_encoder.bert.parameters():
            param.requires_grad = False
    else:
