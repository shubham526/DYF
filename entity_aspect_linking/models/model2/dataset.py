...
class AspectLinkDataset(Dataset):
    ...
    def __getitem__(self, index: int) -> Dict[str, Any]:
        ...
        if self._train:
            if self._data_type == 'pairwise':
                ...
                context_text_input_ids, context_text_attention_mask = self._create_bert_input(example['query']['text'])
                ...
                aspect_text_input_ids_pos, aspect_text_attention_mask_pos = self._create_bert_input(
                ...
                aspect_text_input_ids_neg, aspect_text_attention_mask_neg = self._create_bert_input(
                ...
                return {
                    'context_text_input_ids': context_text_input_ids,
                    'context_text_attention_mask': context_text_attention_mask,
                    ...
                    'aspect_text_input_ids_pos': aspect_text_input_ids_pos,
                    'aspect_text_attention_mask_pos': aspect_text_attention_mask_pos,
                    ...
                    'aspect_text_input_ids_neg': aspect_text_input_ids_neg,
                    'aspect_text_attention_mask_neg': aspect_text_attention_mask_neg,
                ...
                aspect_text_input_ids, aspect_text_attention_mask = self._create_bert_input(
                    example['doc']['text'])
                ...
                return {
                    ...
                    'context_entity_desc_input_ids_and_attention_masks': context_entity_desc_input_ids_and_attention_masks,
                    'context_entity_wiki2vec_embeddings': context_entity_wiki2vec_embeddings,
                    'aspect_text_input_ids': aspect_text_input_ids,
                    'aspect_text_attention_mask': aspect_text_attention_mask,
    ...
    def collate(self, batch):
        if self._train:
            if self._data_type == 'pairwise':
                context_text_input_ids = torch.tensor([item['context_text_input_ids'] for item in batch])
                context_text_attention_mask = torch.tensor([item['context_text_attention_mask'] for item in batch])
                ...
                aspect_text_input_ids_pos = torch.tensor([item['aspect_text_input_ids_pos'] for item in batch])
                aspect_text_attention_mask_pos = torch.tensor(
                    [item['aspect_text_attention_mask_pos'] for item in batch])
                ...
                aspect_text_input_ids_neg = torch.tensor([item['aspect_text_input_ids_neg'] for item in batch])
                aspect_text_attention_mask_neg = torch.tensor(
                    [item['aspect_text_attention_mask_neg'] for item in batch])
                ...
                aspect_text_input_ids = torch.tensor([item['aspect_text_input_ids'] for item in batch])
                aspect_text_attention_mask = torch.tensor(
                    [item['aspect_text_attention_mask'] for item in batch])
