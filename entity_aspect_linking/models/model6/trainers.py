        ...
        def train_step(train_batch):
            ...
            if self._model_type == 'pairwise':
                batch_score_pos = self._model(
                    ...
                    aspect_features=train_batch['aspect_features_pos'].to(self._device)
                )
                ...
                batch_score_neg = self._model(
                    ...
                    aspect_features=train_batch['aspect_features_neg'].to(self._device)
                )
                ...
                batch_score = self._model(
                    ...
                    aspect_features=train_batch['aspect_features'].to(self._device)
                )
